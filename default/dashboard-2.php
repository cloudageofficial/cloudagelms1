                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="card-box widget-box-four">
                                            ...
                                            <div class="wigdet-four-content pull-left">
                                                <h4 class="m-t-0 font-16 m-b-5 font-600 text-overflow" title="Total Revenue">Total Revenue</h4>
                                                <p class="font-secondary text-muted">Jan - Apr 2017</p>
                                                <h3 class="m-b-0 m-t-20 font-600"><span>$</span> <span data-plugin="counterup">5,2548</span></h3>
                                            </div>
                                            <div class="clearfix"></div>
                                        </div>
                                    </div><!-- end col -->
                                    ...
                                    <div class="col-md-4">
                                        <div class="card-box widget-box-four">
                                            ...
                                            <div class="wigdet-four-content pull-left">
                                                <h4 class="m-t-0 font-16 font-600 m-b-5 text-overflow" title="Total Unique Visitors">Total Unique Visitors</h4>
                                                <p class="font-secondary text-muted">Jan - Apr 2017</p>
                                                <h3 class="m-b-0 m-t-20 font-600"><span>$</span> <span data-plugin="counterup">65,241</span></h3>
                                            </div>
                                            <div class="clearfix"></div>
                                        </div>
                                    </div><!-- end col -->
                            ...
                            <div class="col-xl-4">
                                <div class="card-box text-center">
                                    <div class="text-center">
                                        ...
                                        <h3 class="m-b-30"><i class="mdi mdi-arrow-up-bold-hexagon-outline text-success"></i> 48948 <small>USD</small></h3>
                                    </div>
