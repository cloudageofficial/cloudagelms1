                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title float-left">File Manager</h4>

                                    <ol class="breadcrumb float-right">
                                        <li class="breadcrumb-item"><a href="#">Adminox</a></li>
                                        <li class="breadcrumb-item"><a href="#">Admin UI</a></li>
                                        ...
                                        <div class="col-sm-3 col-xl-2">
                                            <div class="file-man-box">
                                                ...
                                                <div class="file-man-title">
                                                    <h5 class="m-b-0 text-overflow">invoice_project.pdf</h5>
...
<!-- Mirrored from coderthemes.com/adminox/default/admin-filemanager.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Mar 2019 05:10:06 GMT -->
</html>